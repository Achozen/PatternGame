...
public class LockPointsPositioner {
    ...
    public static ArrayList<PointPosition> obtainPointCoordinatesForCanvas(int w, int h,
                                                                           ArrayList<PointPosition> points,GameSize gameSize){
    ...
    private static ArrayList<PointPosition> calculateCoordinatesForByGameSize(
            ArrayList<PointPosition> points, int w, int h, int gameSize) {
    ...
    public static ArrayList<PointPosition> calculateCoordinatesForGeneratedPointsByGameSize(
            ArrayList<PointPosition> points, int w, int h, GameSize gameSize) {
        ...
        ArrayList<PointPosition> initLockPoints = PointsInitializer.generateLockPoints(gameSize);
