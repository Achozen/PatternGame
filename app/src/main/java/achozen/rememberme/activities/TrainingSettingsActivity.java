...
public class TrainingSettingsActivity extends Activity {
    ...
    private void clearDifficultyButtonsMarks() {
        ...
        easyButton.setImageDrawable(ContextCompat.getDrawable
                (TrainingSettingsActivity.this, R.drawable.easy_button));
        mediumButton.setImageDrawable(ContextCompat.getDrawable
                (TrainingSettingsActivity.this, R.drawable.medium_button));
        hardButton.setImageDrawable(ContextCompat.getDrawable
                (TrainingSettingsActivity.this, R.drawable.hard_button));
    }
